...
func TestNutsDBStatus_String(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			setup{},
			&NutsDBStatus{},
			"KeyCount: 0, ListIdx: map[], consolidationDbNumFilesThreshold: 0, dbFiles: 0, initalized: false, bufferSize: 0, eventTTL: 0",
		},
		{
			...
			"KeyCount: 0, ListIdx: map[], consolidationDbNumFilesThreshold: 0, dbFiles: 1, initalized: true, bufferSize: 128, eventTTL: 0",
		},
	}
	for _, tt := range tests {
		var path string
